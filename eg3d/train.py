...
@click.option('--snap',         help='How often to save snapshots', metavar='TICKS',            type=click.IntRange(min=1), default=12, show_default=True)
...
def main(**kwargs):
    ...
    c.G_kwargs.class_name = 'training.distillator.Generator'
